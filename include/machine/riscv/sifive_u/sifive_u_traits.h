...
public:
    ...
    static const bool multi = (Traits<Build>::CPUS > 1);
};
...
public:
    ...
    //static const unsigned long CPU_OFFSET = (supervisor | multi) ? 1 : 0; // We skip core zero, which is a E CPU without MMU
    ...
    static const unsigned int STACK_SIZE = 8 * 512;
    static const unsigned int HEAP_SIZE = 4 * 1024 * 512;
};
...
template <>
struct Traits<SPI> : public Traits<Machine_Common>
{
